...
public class studentmarks {
	...
	public static void main(String[] args) {
		String name = "Romeo Kiapa Munyes";
		String rollNo = "C026-01-0976/2022";
		int semester = 1;
		Scanner unitCode= new Scanner(System.in);
		Scanner score= new Scanner(System.in);
		String[] code_ = new String[4];
		int[] score_ = new int[4];
		int total = 0;
		float average;
		String grade = "";
		System.out.print("Enter unit code:");
		for (int i= 0; i<4 ; i++) {
		code_[i] = unitCode.nextLine();
		}
		
		System.out.print("Enter score: ");
		for (int i= 0; i<4 ; i++) {
			score_[i] = score.nextInt();
			total +=score_[i];
			}
		...
		System.out.println("|" + code_[0] + "\t\t|Database \t\t\t|"+score_[0]);
		System.out.println("\n");
		System.out.println("|" + code_[1] + "\t\t|Systems  \t\t\t|" + score_[1]);
		System.out.println("\n");
		System.out.println("|" + code_[2] + " \t\t|Algorithim\t\t\t|" +score_[2]);
		System.out.println("\n");
		System.out.println("|" + code_[3] + "\t\t|Statistics \t\t\t|"+ score_[3]);
		System.out.println("--------------------------------------------------------------------");
